package com.example.artgalleryscreensaver;
...
public class BouncerDaydream extends DreamService {
    int[] artImages = {R.drawable.a, R.drawable.b, R.drawable.c, R.drawable.d, R.drawable.e, R.drawable.f, R.drawable.g, R.drawable.h, R.drawable.i, R.drawable.j, R.drawable.k, R.drawable.l, R.drawable.m, R.drawable.n, R.drawable.o};
    ...
    public void onAttachedToWindow() {
        ...
        int randomNum = ThreadLocalRandom.current().nextInt(0, artImages.length + 1);

        ImageView artImage = findViewById(R.id.art_img);
        artImage.setImageResource(artImages[randomNum]);
